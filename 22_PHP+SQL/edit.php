          ...
          <div class="card-body">
            <form action="#" method="post"> <!-- forma salje podatke istoj stranici POST metodom -->
              ...
              <div class="form-group mb-3">
                <label>Ime:</label>
                <input type="text" name="ime" class="form-control <?php if (isset($errMsg['ime']))
                  echo "is-invalid"; ?>"
                  value="<?php echo $ime; ?>">
              ...
              <div class="form-group mb-3">
                ...
                <input type="text" name="prezime"
                  class="form-control <?php if (isset($errMsg['prezime']))
                    echo "is-invalid"; ?>"
                  value="<?php echo $prezime; ?>">
                <span class="invalid-feedback">
                  <?php if (isset($errMsg['prezime']))
                    echo $errMsg['prezime']; ?>
                </span>
              </div>
              <div class="form-group mb-3">
                ...
                <input type="text" name="email"
                  class="form-control <?php if (isset($errMsg['email']))
                    echo "is-invalid"; ?>"
              ...
              <div class="form-group mb-3">
                ...
                <input type="text" name="broj_telefona"
                  class="form-control <?php if (isset($errMsg['broj_telefona'])) {
                    echo "is-invalid";
                  } ?>"
                  value="<?php echo $broj_telefona; ?>">
                <span class="invalid-feedback">
                  <?php if (isset($errMsg['broj_telefona']))
                    echo $errMsg['broj_telefona']; ?>
                </span>
              </div>
              <div class="float-end mb-3">
                <button type="sumbit" class="btn btn-success"> Sacuvaj </button>
                <!-- Unutar forme moramo da imamo submit dugme na ciji se klik zapravo salju podaci -->
